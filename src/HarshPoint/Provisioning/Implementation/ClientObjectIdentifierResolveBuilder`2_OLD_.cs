...
{
    public abstract class ClientObjectIdentifierResolveBuilder_OLD<TResult, TIdentifier> :
        IdentifierResolveBuilder<TResult, ClientObjectResolveContext, TIdentifier>
        where TResult : ClientObject
    {
        protected ClientObjectIdentifierResolveBuilder_OLD(
        ...
        private static readonly HarshLogger Logger
            = HarshLog.ForContext(typeof(ClientObjectIdentifierResolveBuilder_OLD<,>));
    }
}
