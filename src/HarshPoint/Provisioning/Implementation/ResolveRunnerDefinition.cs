...
{
    internal sealed class ResolveRunnerDefinition
    {
        ...
        public ResolveRunnerDefinition(
            String name,
        ...
        private static readonly HarshLogger Logger = HarshLog.ForContext<ResolveRunnerDefinition>();
    }
}
