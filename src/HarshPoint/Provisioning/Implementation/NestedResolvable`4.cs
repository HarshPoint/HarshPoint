...
namespace HarshPoint.Provisioning.Implementation
{
    ...
    public abstract class NestedResolvable<T1, T2, TContext, TSelf> :
        ...
        IResolvableChainElement<Tuple<T1, T2>>,
        IResolvableChainElement<T2>,

        IResolve<IGrouping<T1, T2>>,
        IResolve<Tuple<T1, T2>>,
        IResolve<T2>
        ...
        where TSelf : NestedResolvable<T1, T2, TContext, TSelf>
    {
        ...
        [SuppressMessage("Microsoft.Design", "CA1006:DoNotNestGenericTypesInMemberSignatures")]
        public TSelf And(IResolvableChainElement<Tuple<T1, T2>> other)
        {
            if (other == null)
            {
                throw Error.ArgumentNull(nameof(other));
        ...
        [SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes")]
        async Task<IEnumerable<Tuple<T1, T2>>> IResolvableChainElement<Tuple<T1, T2>>.ResolveChainElement(IResolveContext context)
        ...
        [SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes")]
        Task<IEnumerable<Tuple<T1, T2>>> IResolve<Tuple<T1, T2>>.TryResolveAsync(IResolveContext context)
            => ResolveChain<Tuple<T1, T2>>(context);
