...
namespace HarshPoint {
    ...
    internal class SR {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The specified provisioner has no current ParameterSet..
        /// </summary>
        internal static string ClientObjectUpdater_NoParameterSet {
            get {
                return ResourceManager.GetString("ClientObjectUpdater_NoParameterSet", resourceCulture);
            }
        }
